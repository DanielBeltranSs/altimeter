...
// --- al tope, cerca de los #define del módulo ---
#ifndef FORCED_AHORRO_MS
#define FORCED_AHORRO_MS 2000UL
#endif

// Devuelve ms restantes para la próxima FORCED en modo AHORRO (0 si ya toca leer)
